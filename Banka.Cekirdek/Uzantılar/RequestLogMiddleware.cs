...
namespace Banka.Cekirdek.Uzantılar
{
    public class RequestLogMiddleware
    {
        ...
        private readonly IIstekLoguServis _istekLoguServis;

        public RequestLogMiddleware(RequestDelegate next, ILogger<RequestLogMiddleware> logger, IIstekLoguServis istekLoguServis)
        {
            _next = next;
            _logger = logger;
